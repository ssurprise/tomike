 ...
 * <p>
 * 注：修改变动
 * 对TabLayout 和 ViewPager2联动的效果做了一丢丢的优化，使其支持ViewPager2 手动滑动时有效果，TabLayout 点击时无滑动效果。
 * 解决smoothScroll为false时，ViewPager2手动滑动生硬的问题。
 */
public final class TabLayoutMediatorX {
    @NonNull
    ...
    public void attach() {
        ...
        onPageChangeCallback = new TabLayoutOnPageChangeCallback(tabLayout, onTabSelectedListener);
    ...
    private static class TabLayoutOnPageChangeCallback extends ViewPager2.OnPageChangeCallback {
        ...
        private final WeakReference<ViewPagerOnTabSelectedListener> onTabSelectedListenerRef;
        private int previousScrollState;
        private int scrollState;

        TabLayoutOnPageChangeCallback(TabLayout tabLayout, ViewPagerOnTabSelectedListener onTabSelectedListener) {
            tabLayoutRef = new WeakReference<>(tabLayout);
            onTabSelectedListenerRef = new WeakReference<>(onTabSelectedListener);
            reset();
        }
        ...
        public void onPageSelected(final int position) {
            ...
            if (tabLayout != null
                ...
                if (onTabSelectedListenerRef != null && onTabSelectedListenerRef.get() != null) {
                    onTabSelectedListenerRef.get().unrelatedScroll = false;
                }
                tabLayout.selectTab(tabLayout.getTabAt(position), updateIndicator);
                if (onTabSelectedListenerRef != null && onTabSelectedListenerRef.get() != null) {
                    onTabSelectedListenerRef.get().unrelatedScroll = true;
                }
            }
        }
    ...
    private static class ViewPagerOnTabSelectedListener implements TabLayout.OnTabSelectedListener {
        private final ViewPager2 viewPager;
        private final boolean smoothScroll;
        private boolean unrelatedScroll = true;
        ...
        public void onTabSelected(@NonNull TabLayout.Tab tab) {
            viewPager.setCurrentItem(tab.getPosition(), !unrelatedScroll || smoothScroll);
        }
        ...
        public void setUnrelatedScroll(boolean unrelatedScroll) {
            this.unrelatedScroll = unrelatedScroll;
        }
    }
