...
public class MultiplePagerAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        ImageView imageView = (ImageView) view.findViewById(R.id.multiple_page_img);
        ImageView hoverImageView = (ImageView) view.findViewById(R.id.multiple_page_hoverImg);
