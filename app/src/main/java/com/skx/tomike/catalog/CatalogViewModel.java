...
import static com.skx.tomike.cannon.RouteConstantsKt.ROUTE_PATH_DOWNLOAD;
...
import static com.skx.tomike.cannon.RouteConstantsKt.ROUTE_PATH_JOB_SCHEDULER;
...
import static com.skx.tomike.cannon.RouteConstantsKt.ROUTE_PATH_WORK_MANAGER;
...
public class CatalogViewModel extends BaseViewModel<BaseRepository<?>> {
    ...
    static {
        ...
        mFunctionCatalogs.add(new CatalogItem("下载管理", ROUTE_PATH_DOWNLOAD));
