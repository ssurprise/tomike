...
public class KeyboardActivity2 extends SkxBaseActivity<BaseViewModel> {
    ...
    private final ViewTreeObserver.OnGlobalLayoutListener mGlobalLayoutListener = new ViewTreeObserver.OnGlobalLayoutListener() {
        ...
        public void onGlobalLayout() {
            ...
            int keyboardHeight = screenHeight - (r.bottom - r.top) - ScreenUtilKt.getStatusBarHeight(mActivity);
            boolean isKeyboardShowing = keyboardHeight > screenHeight / 3; //如果之前软键盘状态为显示，现在为关闭，或者之前为关闭，现在为显示，则表示软键盘的状态发生了改变
            Log.e(TAG, "screenHeight: " + screenHeight + " keyboardHeight：" + keyboardHeight);
    ...
    private void showInputKeyboard() {
        ...
        //打开输入法
        KeyboardTool.getInstances(KeyboardActivity2.this).showKeyboard(mEditText);
    ...
    private void showEmojiView() {
        ...
        if (fl_keyboard_content.getVisibility() != View.VISIBLE) {
            ...
            fl_keyboard_content.setVisibility(View.VISIBLE);
            //关闭键盘
            KeyboardTool.getInstances(KeyboardActivity2.this).hideKeyboard(mEditText);
        }
