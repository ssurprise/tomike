...
const val ROUTE_PATH_JOB_SCHEDULER = "${ROUTER_FIRST_LEVEL_FUNCTION}/jobScheduler"
const val ROUTE_PATH_WORK_MANAGER = "${ROUTER_FIRST_LEVEL_FUNCTION}/workManager"
const val ROUTE_PATH_ALARM_MANAGER = "${ROUTER_FIRST_LEVEL_FUNCTION}/alarmManager"
...
const val ROUTE_PATH_DOWNLOAD = "${ROUTER_FIRST_LEVEL_FUNCTION}/download"
...
const val ROUTE_PATH_APP_INFO = "${ROUTER_FIRST_LEVEL_FUNCTION}/app/info"
...
const val ROUTE_PATH_PACKAGE_LIST = "${ROUTER_FIRST_LEVEL_FUNCTION}/package/list"
const val ROUTE_PATH_APP_USAGE_STATS = "${ROUTER_FIRST_LEVEL_FUNCTION}/app/usageStats"
const val ROUTE_PATH_H5 = "${ROUTER_FIRST_LEVEL_FUNCTION}/app/h5"
